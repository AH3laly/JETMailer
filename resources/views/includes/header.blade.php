...
<div class="topbar">
   ...
   <div class="topbar-left">
      <div class="text-center">
         <a href="/" class="logo"><i class="icon-fire icon-c-logo"></i><span>JET <i class="icon-fire"></i> Mailer</span></a>
      </div>
   </div>
      ...
      <div class="container">
         <div class="">
            ...
            <ul class="nav navbar-nav navbar-right pull-right">
               <li class="hidden-xs">
                  <a href="#" id="btn-fullscreen" class="ui2-effect ui2-light"><i class="icon-size-fullscreen"></i></a>
               </li>
               <li class="hidden-xs">
                  <a href="#" class="right-bar-toggle ui2-effect ui2-light"><i class="icon-settings"></i></a>
               </li>
               <li class="dropdown">
         ...
         <ul>
            ...
            <li class="ui_sub">
               ...
               <ul class="list-unstyled">
                  ...
                  <li id="tab-logs"><a href="/logs">Logs</a></li>
               </ul>
            </li>
         </ul>
